...
<div class="w3l-heading">
				<h1>Your all in one Business Platform</h1>
				<h2 class="w3ls_test">Manage your Schedules. Control your Business</h2>
			</div>
</div>
...
<div class="container">
  <div class="row">
  <div class="col-sm-6">
		<h4>What Booking Times does:</h4><br>
	<ul>
				<li>Organizes scheduling, staff, reminders &amp; follow ups</li><br>
                <li>Manages payments, invoicing &amp; client details</li><br>
                <li>Automates marketing</li><br>
                <li>Tracks your financials &amp; commissions</li><br>
                 <li>Turns your website into a 24/7 booking engine</li>
                </ul>
    </div>
    <div class="col-sm-6">
