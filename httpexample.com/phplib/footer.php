<div class="w3-agile-footer">
		<div class="container">
			<div class="footer-grids">
				<div class="col-md-3 footer-grid">
					...
					<div class="footer-grid-info">
						<p>Coimbatur
							<span>TamilNadu 56777.</span>
						</p>
						<p class="phone">Phone : 99999999
				...
				<div class="col-md-3 footer-grid">
					...
					<div class="footer-grid-info">
						<ul>
							...
							<li><a href="product description.html">Price</a></li>
			...
			<div class="agileits-w3layouts-copyright">
				<p>© 2021 Driving School . All Rights Reserved | Design by <a href="#"> Trinity Info</a> </p>
			</div>
		</div>
	</div>